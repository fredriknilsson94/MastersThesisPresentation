...
\begin{frame}{Different Image Measurements}
	...
	\column{0.45\textwidth}
	\begin{tikzpicture}
		\node[] at (0,0) {\includegraphics[angle=-90,origin=c,trim={0 0 15cm 0},width=\textwidth]{roi_example}};
	...
	\end{tikzpicture}
	\begin{tikzpicture}
		\node[] at (0,0) {\includegraphics[angle=-90,origin=c,trim={0 0 16cm 0},width=\textwidth]{corners_example}};
